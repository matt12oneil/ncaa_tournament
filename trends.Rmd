...
team <- ggplot(upsets, aes(x=team_rk)) + geom_histogram(bins = 15, aes(y =..density..)) + geom_density() + ggtitle(label = '7+ S16 or Greater by Team Rank') + ylim(0,.03) + xlim(0,250)
d <- ggplot(upsets, aes(x=adj_d_rk)) + geom_histogram(bins = 15, aes(y =..density..)) + geom_density() + ggtitle(label = '7+ S16 or Greater by Adj D Rank') + ylim(0,.03) + xlim(0,250)
o <- ggplot(upsets, aes(x=adj_o_rk)) + geom_histogram(bins = 15, aes(y =..density..)) + geom_density() + ggtitle(label = '7+ S16 or Greater by Adj O Rank') + ylim(0,.03) + xlim(0,250)
